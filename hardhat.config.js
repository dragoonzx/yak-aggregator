...
const AVALANCHE_DEPLOY_RPC =
  process.env.AVALANCHE_DEPLOY_RPC || process.env.AVALANCHE_FORK_RPC;
...
task("verifyContract", "Verifies the contract in the snowtrace")
  ...
  .setAction(async ({ deploymentFilePath }, hre) =>
    verifyContract(deploymentFilePath, hre)
  );
